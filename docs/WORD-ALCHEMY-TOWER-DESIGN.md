...
- `字根煉金塔-完整修正版.sb3`：目前網站匯入來源；包含排行榜對齊、前五名排序、1／2／3 輸入重試，以及第二次選擇不提前揭露正確詞綴。
...
```powershell
npm run import-game -- "字根煉金塔-完整修正版.sb3" --id 24871579-c8c8-48e1-a6da-474433f1c16e --replace --leaderboard
