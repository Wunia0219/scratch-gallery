...
<template>
  ...
  <header class="site-header">
    ...
    <nav aria-label="主要導覽"><a href="/#games">所有作品</a></nav>
  </header>
  <main id="main-content">
    <section class="work-intro">
      <p><a href="/">首頁</a> / {{ game.title }}</p>
      ...
      <div class="work-cover"><GameCard :game="game" @play="selectedGame = $event" /></div>
    ...
    <section v-if="related.length" class="work-related">
      ...
      <div class="game-grid"><GameCard v-for="item in related" :key="item.id" :game="item" @play="selectedGame = $event" /></div>
    </section>
  </main>
