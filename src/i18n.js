...
const messages = {
  'zh-Hant': {
    ...
    announcementsTitle: '最新活動公告', announcementsIntro: '從主題挑戰到成果分享，在這裡找到下一個創作靈感。', halloweenStatus: '9/28 開始徵稿', halloweenLabel: '本期活動', halloweenTitle: '萬聖節魔法 Scratch 創作挑戰', halloweenSummary: '南瓜燈正在等待大家的創意！用 Scratch 做出遊戲、動畫、互動故事或藝術作品，一起點亮萬聖節魔法派對。', halloweenDetailsLabel: '投稿重點', halloweenDatesTitle: '投稿期間', halloweenDates: '2026 年 9 月 28 日－10 月 23 日', halloweenFormatsTitle: '創作形式', halloweenFormats: '遊戲、動畫、互動故事、繪圖或其他 Scratch 創作', halloweenFileTitle: '投稿檔案', halloweenFile: '上傳 1 個 SB3 檔案，檔案大小上限 10 MB', halloweenSubmit: '前往投稿', halloweenPreviewLabel: '活動說明', halloweenPreviewPlay: '播放萬聖節活動說明', halloweenPreviewAlt: '萬聖節魔法 Scratch 創作挑戰活動說明預覽', halloweenArtLine: '點擊預覽，聽小鹿介紹萬聖節魔法任務。',
  ...
  en: {
    ...
    announcementsTitle: 'Latest events', announcementsIntro: 'Find themed challenges, gallery news, and a fresh reason to start creating.', halloweenStatus: 'Submissions open Sep 28', halloweenLabel: 'Featured event', halloweenTitle: 'Halloween Magic Scratch Challenge', halloweenSummary: 'The pumpkin lights need your ideas! Create a Scratch game, animation, interactive story, or artwork and help light up our Halloween party.', halloweenDetailsLabel: 'Submission highlights', halloweenDatesTitle: 'Submission period', halloweenDates: 'September 28–October 23, 2026', halloweenFormatsTitle: 'What to create', halloweenFormats: 'A game, animation, interactive story, artwork, or another Scratch creation', halloweenFileTitle: 'What to upload', halloweenFile: 'One SB3 file, up to 10 MB', halloweenSubmit: 'Submit your project', halloweenPreviewLabel: 'Event preview', halloweenPreviewPlay: 'Play the Halloween activity introduction', halloweenPreviewAlt: 'Preview of the Halloween Magic Scratch Challenge introduction', halloweenArtLine: 'Select the preview to hear the giraffe introduce the Halloween magic mission.',
